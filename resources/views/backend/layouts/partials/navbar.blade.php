...
<div class="navbar-right ">
   ...
   <ul class="nav navbar-nav">
      ...
      <li class="dropdown user-menu">
         ...
         <img src="{{ !empty(auth()->user()->profile_picture) ? asset('storage/users/'.auth()->user()->profile_picture) : asset('backend_assets/images/default-user-image.png') }}" class="user-image rounded-circle" alt="User Image" />
         ...
         <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li class="dropdown-footer">
               <a class="dropdown-link-item" href="{{ route('admin.logout') }}" onclick="event.preventDefault();document.getElementById('form-logout').submit();"> <i class="mdi mdi-logout"></i> Log Out
                  <form id="form-logout" class="d-none" action="{{ route('admin.logout') }}" method="POST">
                     {{ csrf_field() }}
                  </form>
                </a>
            </li>
